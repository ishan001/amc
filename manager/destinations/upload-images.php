...
$DImgs = DESTINATION :: getDestiImages($D_ID);

$desDet = DESTINATION :: getDestiDet($D_ID);
?>
<!doctype html>
...
<title>Upload Destination Images :: Travel Network</title>
  ...
  <div id=main role=main>
    ...
    <div id=main-content>
      <div class=container_12>
        <div class=grid_12>
          <h1>Upload Destination Images - <?=$desDet['D_NAME']?></h1>
        </div>
        <div class=grid_12>
          <div class=block-border>
            ...
            <div class="block-content">
             	<div id="mainDivImage">
                  ...
                  <?php 
				  		foreach($DImgs as $rowImg) { ?>
                    <li id="<?=$rowImg['DI_ID']?>"> <img src="<?=URL_ORI?>upload/destination/thumb/<?=$rowImg['DI_NAME']?>"  />
                      <ul>
                        <li class="delete"><a href="javascript:ConfirmDelete('<?=$rowImg['D_ID']?>')" >Delete</a></li>
                      </ul>
                    </li>
                    <? } ?>
                        ...
                        <div  id="buttonNextDiv"><input type="hidden"  name="D_ID" id="D_ID" value="<?=$D_ID;?>"  /></div>
...
$(function () {
		...
		new AjaxUpload(btnUpload, {
			...
			onComplete: function(file, response){
				...
				$('#files').append('<li id='+str[1]+'><img src="../../upload/destination/thumb/'+str[0]+'"   /><ul><li class="delete"><a href="javascript:ConfirmDelete(\''+str[1]+'\')">Delete</a></li></ul></li>');
			}
		});
