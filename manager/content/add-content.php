...
<title>Ave Maria Convent Branch  :: Add New Content</title>
  ...
  <div id=main role=main>
    <div id=title-bar>
      <ul id=breadcrumbs>
        ...
        <li class=no-hover>Add  Content</li>
      </ul>
    </div>
                ...
                <div class=_100>
                  <p>
                   <label for=C_NAME>Title</label>
                    <input type="text" id="C_NAME" name="C_NAME" class=required  />
                  </p>
                </div>
                 ...
                 <div class=_100>
                  <p>
                    ...
                    <textarea id=C_DATA name=C_DATA  rows=5 cols=40></textarea>
...
$().ready(function() {
		$.validator.setDefaults({
			submitHandler: function(e) {
				...
				dataString = $("#formStudent").serialize()+'&action=addContent&C_DATA='+escape(CKEDITOR.instances.C_DATA.getData());
