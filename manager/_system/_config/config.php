<?php
	...
	if($server == 'localhost' ) 
	{
		...
		#path information
		define('REAL_PATH', $_SERVER['DOCUMENT_ROOT'].'/avemaria/manager/');	#real path
		define('REAL_PATH_UPLIOAD', $_SERVER['DOCUMENT_ROOT'].'/avemaria/manager/');	#real path upload
		define('URL', 'http://'.$server.'/avemaria/manager/');			#access URL
		define('URL_ORI', 'http://'.$server.'/avemaria/');			#access URL
		define('SEPARATOR', '\\');								#separator
		define('URL_REWRITING', false);							#url rewriting
		define('ROOT_EDITOR', '/manager/');	
	}
	else 
	{
		...
		#path information
		define('REAL_PATH', '/var/www/avemariaconventbolawalana.com/manager/');		#real path
		define('REAL_PATH_UPLIOAD', '/var/www/avemariaconventbolawalana.com/manager/');	#real path upload
		define('URL', 'http://www.avemariaconventbolawalana.com/manager/');				#access URL
		define('SEPARATOR', '/');										#separator
		define('URL_REWRITING', false);									#url rewriting	
		define('ROOT_EDITOR', 'http://www.avemariaconventbolawalana.com/manager/');	
	}
