...
<title>Add New Hotel :: Travel Network</title>
  ...
  <div id=main role=main>
    <div id=title-bar>
      <ul id=breadcrumbs>
        ...
        <li class=no-hover>Add Hotel</li>
      </ul>
    </div>
              ...
              <fieldset>
                ...
                <div class=_50>
                  <p>
                    ...
                    <input id=H_NAME type=text  name="H_NAME" class=required />
                  </p>
                </div>
                <div class=_50>
                  <p>
                    <label for=H_EMAIL>Email</label>
                    <input id=H_EMAIL type=text value="" name=H_EMAIL class="required email " />
                  </p>
                </div>
                <div class=_50>
                  <p>
                  <label for=H_WEB>Web Address</label>
                    <input id=H_WEB name=H_WEB class=required type=text value=""/>
                ...
                <div class=_50>
                  <p>
                    ...
                    <input id=H_PHONE name=H_PHONE class=required type=text value=""/>
                  </p>
                </div>
                 <div class=_50>
                  <p>
                    <label for=H_ROOM_PRICE>ROOM Price</label>
                    <input id=H_ROOM_PRICE name=H_ROOM_PRICE class=required type=text value=""/>
                  </p>
                </div>
                <div class=_50>
                  <p>
                    <label for=textfield>Address</label>
                    <textarea id=H_ADDRESS name=H_ADDRESS class=required rows=5 cols=40></textarea>
                  </p>
                </div>
              </fieldset>
              <fieldset>
                ...
                <div class=_50>
                  ...
                  <label for=H_COUNTRY>Country</label>
                    <select name="H_COUNTRY" id="H_COUNTRY" class="required "> 
                        ...
                        <option value="<?=$rowCnt['cntname']?>"><?=$rowCnt['cntname']?></option> 
                        <? } ?>
					</select>
                 ...
                 <div class=_50>
                  <p>
                    ...
                    <input id=H_CITY name=H_CITY class=required type=text value=""/>
                  </p>
                </div>
                <div class=_50>
                  <p>
                    <label for=H_LONGI>Longitude</label>
                    <input id=H_LONGI name=H_LONGI  type=text value=""/>
                  </p>
                </div>
                <div class=_50>
                  <p>
                    <label for=H_LATITUDE>Latitude</label>
                    <input id=H_LATITUDE name=H_LATITUDE  type=text value=""/>
                  </p>
                </div>
              ...
              <fieldset>
                ...
                <div class=_100>
                  <p>
                    ...
                    <textarea id=H_OVERVIEW name=H_OVERVIEW class=required rows=5 cols=40></textarea>
                ...
                <div class=_100>
                  <p>
                    ...
                    <textarea id=H_ACCOMMODATION name=H_ACCOMMODATION class=required rows=5 cols=40></textarea>
                    <script type="text/javascript">
                ...
                <div class=_100>
                  <p>
                    ...
                    <textarea id=H_DINING name=H_DINING class=required rows=5 cols=40></textarea>
                    <script type="text/javascript">
                ...
                <div class=_100>
                  <p>
                    ...
                    <textarea id=H_ENTERTAINMENT name=H_ENTERTAINMENT class=required rows=5 cols=40></textarea>
                    <script type="text/javascript">
                ...
                <div class=_100>
                  <p>
                    ...
                    <textarea id=H_FACILITIES name=H_FACILITIES class=required rows=5 cols=40></textarea>
                    <script type="text/javascript">
...
<script language="javascript">
	$().ready(function() {
		...
		/*dataString = $("#formAddHotel").serialize()+'&action=addHotel&H_OVERVIEW='+CKEDITOR.instances.H_OVERVIEW.getData();+'&H_ACCOMMODATION='+CKEDITOR.instances.H_ACCOMMODATION.getData();+'&H_DINING='+CKEDITOR.instances.H_DINING.getData();+'&H_ENTERTAINMENT='+CKEDITOR.instances.H_ENTERTAINMENT.getData();+'&H_FACILITIES='+CKEDITOR.instances.H_FACILITIES.getData();+'';
				...
				$.post("../_controller/accommodation-controller.php",{action:'addHotel',H_OVERVIEW:CKEDITOR.instances.H_OVERVIEW.getData(),H_ACCOMMODATION:CKEDITOR.instances.H_ACCOMMODATION.getData(),H_DINING:CKEDITOR.instances.H_DINING.getData(),H_ENTERTAINMENT:CKEDITOR.instances.H_ENTERTAINMENT.getData(),H_FACILITIES:CKEDITOR.instances.H_FACILITIES.getData(), H_TYPE:$('#H_TYPE').val(), H_NAME:$('#H_NAME').val(), H_EMAIL:$('#H_EMAIL').val(), H_WEB:$('#H_WEB').val(), H_PHONE:$('#H_PHONE').val(), H_ROOM_PRICE:$('#H_ROOM_PRICE').val(), H_ADDRESS:$('#H_ADDRESS').val(), H_COUNTRY:$('#H_COUNTRY').val(), H_CITY:$('#H_CITY').val(), H_LONGI:$('#H_LONGI').val(), H_LATITUDE:$('#H_LATITUDE').val()},function(data)
