...
<title>Ave Maria Convent Branch  :: Add  Event</title>
  ...
  <div id=main role=main>
    <div id=title-bar>
      <ul id=breadcrumbs>
        ...
        <li class=no-hover>Add  Event</li>
      </ul>
    </div>
                ...
                <div class=_50>
                  <p>
                   <label for=N_TITLE>Title</label>
                    <input type="text" id="E_TITLE" name="E_TITLE" class=required  />
                  </p>
                </div>
                <div class=_50>
                  <p>
                   <label for=N_DATE>Date</label>
                    <input type="text" id="E_DATE" name="E_DATE" class=required  />
                  </p>
                </div>
                <div class=_50>
                  <p>
                ...
                <div class=_50>
                  <p>
                   <label for=N_TITLE>Location</label>
                    <input type="text" id="E_LOCATION" name="E_LOCATION" class=required  />
                  </p>
                </div>
 ...
 <img id="loading" src="../images/loader.gif" style="display:none;">
                 ...
                 <div class=_100>
                  <p>
                    ...
                    <textarea id=E_DESCRIPTION name=E_DESCRIPTION  rows=5 cols=40></textarea>
...
$().ready(function() {
		$.validator.setDefaults({
			submitHandler: function(e) {
				...
				dataString = $("#formEvent").serialize()+'&E_DESCRIPTION2='+CKEDITOR.instances.E_DESCRIPTION.getData()+'&action=addEvent';
