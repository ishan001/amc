...
<title>Ave Maria Convent Branch  :: Add  Gallery </title>
  ...
  <div id=main role=main>
    <div id=title-bar>
      <ul id=breadcrumbs>
        ...
        <li class=no-hover>Add  Gallery</li>
      </ul>
    </div>
                ...
                <div class=_50>
                  <p>
                   <label for=N_TITLE>Title</label>
                    <input type="text" id="G_NAME" name="G_NAME" class=required  />
                  </p>
                </div>
...
$().ready(function() {
		$.validator.setDefaults({
			submitHandler: function(e) {
				...
				dataString = $("#formGallery").serialize()+'&action=addGallery';
		...
		function(data){
			...
			window.location = "upload-images.php?G_ID="+data;
		});
