...
<title>Ave Maria Convent Branch  :: Add  News</title>
          ...
          <div class=block-border>
            ...
            <form id="formNews" class="block-content form" action="" method=post  >
              ...
              <fieldset>
                ...
                <div class=_50>
                  <p>
                   <label for=N_TITLE>Title</label>
                    <input type="text" id="N_TITLE" name="N_TITLE" class=required  />
                  </p>
                </div>
                <div class=_50>
                  <p>
                   <label for=N_DATE>Date</label>
                    <input type="text" id="N_DATE" name="N_DATE" class=required  />
                  </p>
                </div>
                 ...
                 <div class=_100>
                  <p>
                    ...
                    <textarea id=N_DESCRIPTION name=N_DESCRIPTION  rows=5 cols=40></textarea>
                ...
                <div class=_50>
                  <p>
                  <label for=N_DATE>Link to Gallery</label>
                  <select id="N_GAL_ID" name="N_GAL_ID"  >
                  <option value="">Select Gallery</option>
				  <?php foreach($gal as $rowGal ) { ?>
                  		<option value="<?=$rowGal['G_ID']?>"><?=$rowGal['G_NAME']?></option>
                  <? } ?>
...
$().ready(function() {
		$.validator.setDefaults({
			submitHandler: function(e) {
				...
				dataString = $("#formNews").serialize()+'&N_DESCRIPTION2='+CKEDITOR.instances.N_DESCRIPTION.getData()+'&action=addNews';
		...
		function(data){
			...
			window.location = "upload-images.php?N_ID="+data;
		});
