...
$().ready(function() {
		$.validator.setDefaults({
			submitHandler: function(e) {
				...
				dataString = $("#formTeacher").serialize()+'&action=addTeacher&T_DESCRIPTION='+des;
...
$( "#T_JOINED_DATE" ).datepicker();			
		var validateform = $("#formTeacher").validate({
        	rules: {
            	 T_NAME: { remote: "../_controller/teacher-controller.php?action=validateTeacher" } ,
        	},
			messages: {
        		 T_NAME: { remote: "Teacher Already Exists"},
