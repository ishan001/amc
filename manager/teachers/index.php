...
<title>Ave Maria Convent Branch  :: Teachers</title>
          ...
          <div class=block-border>
            <div class=block-content>
              <table id=table-all class=table>
                ...
                <tbody>
                <?php foreach($teachers as $rowTeacher) { 	?>
                  <tr >
                    <td><?=$rowTeacher['T_NAME']?></td>
                    <td><?=$rowTeacher['T_JOINED_DATE']?></td>
                    <td><?=$rowTeacher['T_CLASS_TECH']?></td>
                    <td style="text-align:center"><a href="edit-teacher.php?T_ID=<?=$rowTeacher['T_ID']?>"><img src="../images/ico_edit_16.png" title="Edit Teacher" ></a> &nbsp; <a href="#"><img src="../images/ico_delete_16.png" title="Delete Teacher" ></a></td>
...
$('#nav_teachers_all').addClass('current');	
