...
if(!empty($_FILES[$fileElementName]['error']))
	...
	}else 
	{
			...
			$uploadfile ="../../upload/teachers/thumb/".$filename;
			createExactThumb($_FILES['fileToUpload']['tmp_name'],$uploadfile,75,75,$key);
			//createThumb($_FILES['fileToUpload']['tmp_name'],$uploadfile,75,75,$key);
			
			
			$uploadfile ="../../upload/teachers/".$filename;
			createThumb($_FILES['fileToUpload']['tmp_name'],$uploadfile,150,200,$key);
			$msg .= $filename;
			$_SESSION['teacherProImg'] = $filename;
